...
$(document).ready(function(){
  ...
  $('.blog-index__popular-post').owlCarousel({
    loop: true,
    nav: false,
    dots: true,
    margin: 0,
  ...
  $('.blog-comments-nav .mwb-button-link').on('click', function(e){
    e.preventDefault();
    $(this).parents('.blog-comments-nav').next('.blog-comments').show('slow');
  });

  $('.mwb-header-toggle').on('click', function(e){
    $(this).toggleClass('open-nav');
    $(this).parents('.mwb-header').children('.mwb-header-mob').toggle('500');
  });

  $('.has-submenu .menu-arrow').on('click', function(e){
    $(this).toggleClass('menu-arrow--active');
    $(this).siblings('.submenu').toggle('500');
  });
  
  $('.mwb-header__search .btn-search').on('click', function(){
    $(this).siblings('.hs-search-field__bar').toggle();
  });
  ...
  $('.scroll-to-top-wrap').click(function(){
